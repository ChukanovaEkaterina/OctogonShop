# Проект по автоматизации тестирования интернет магазина спортивной одежды и экипировки для единоборств Octagon-Shop.com
## :pushpin: Содержание:
...
```
При выполнении команды, данные тесты запускаются удаленно в <code>Selenoid</code>.
